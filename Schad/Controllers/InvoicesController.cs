...
namespace Schad.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            ViewBag.invoice = db.Invoices.Where(x => x.Id == id).First();
        ...
        {
            ViewBag.CustomerId = new SelectList(db.Customers.Where(x => x.Status), "Id", "CustName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerId,TotalItbis,SubTotal,Total")] Invoice invoice)
        {
        ...
        {
            return RedirectToAction("Create", "InvoiceDetails");
        }

        public ActionResult CreateWithId(int? id)
        {
            ViewBag.InvoiceId = id;
            return RedirectToAction("CreateWithId/" + id, "InvoiceDetails");
        }
